"""
Fixed search engine module for PythonAnywhere compatibility.
"""
...
async def search_site(session: aiohttp.ClientSession, site_name: str, site_config: dict, query: str, headers: dict) -> list[dict]:
    """Search a single site for movies - optimized for PythonAnywhere."""
    results = []
...
async def search_movie(query: str) -> list[dict]:
    """Search for movies across all enabled sites - optimized for PythonAnywhere."""
    headers = {
